...
describe('Unit testing', () => {
  test('Like Comment Mutation without User', async () => {
    const args = {};
  ...
  test('Like Comment Mutation without existing Comment', async () => {
    // SignUp a User
  ...
  test('Like Comment Mutation if already liked by the user', async () => {
    // SignUp the User
    let nameForNewUser = shortid.generate().toLowerCase();
    let email = `${nameForNewUser}@test.com`;
    let args = {
    ...
    const response = await likeComment({}, args, context);
  ...
  test('Like Comment Mutation', async () => {
    // SignUp the User
    let nameForNewUser = shortid.generate().toLowerCase();
    let email = `${nameForNewUser}@test.com`;
    let args = {
